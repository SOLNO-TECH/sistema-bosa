          ...
          <div className="p-6">
            ...
            {activeTab === 'security' && (
              <div className="max-w-2xl space-y-6 animate-fade-in">
                ...
                {/* 2FA */}
                <div className="flex items-start justify-between gap-4 p-5 border border-gold/30 bg-gold/5 rounded-xl">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-navy-900 font-bold text-sm mb-1">Autenticación en Dos Pasos (2FA)</h4>
                      <p className="text-navy-600 text-xs leading-relaxed">Agrega una capa adicional de seguridad a tu cuenta requiriendo un código desde tu dispositivo móvil.</p>
                    </div>
                  </div>
                  <button className="flex-shrink-0 px-4 py-2 rounded-lg border border-gold/50 text-gold hover:bg-gold/10 transition-all text-xs font-bold uppercase tracking-wide">
                    Configurar
                  </button>
                </div>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-4 pb-3 border-b border-gray-100">
                    ...
                    <h4 className="font-label font-bold text-navy-950 text-[10px] tracking-wider uppercase">Cambio de Contraseña</h4>
                  </div>
                  <div className="space-y-4">
                    <div className="space-y-1.5">
                      <label className="font-label font-bold text-navy-950 text-[10px] tracking-wider uppercase">Contraseña Actual</label>
                      <input type="password" placeholder="••••••••" className="w-full border-2 border-gray-300 rounded-lg px-4 py-2.5 text-navy-950 placeholder-gray-400 focus:border-gold focus:ring-1 focus:ring-gold outline-none transition-all bg-white" />
                    </div>
                    <div className="space-y-1.5">
                    ...
                    <div className="space-y-1.5">
                      <label className="font-label font-bold text-navy-950 text-[10px] tracking-wider uppercase">Confirmar Nueva Contraseña</label>
                      <input type="password" placeholder="••••••••" className="w-full border-2 border-gray-300 rounded-lg px-4 py-2.5 text-navy-950 placeholder-gray-400 focus:border-gold focus:ring-1 focus:ring-gold outline-none transition-all bg-white" />
                    </div>
                    <div className="flex justify-end pt-2">
                      <button className="btn-gold">Actualizar Contraseña</button>
                    </div>
                  </div>
                </div>
